...
class CPU(models.Model):
    ...
    core_clock = models.DecimalField(
    ...
    userbenchmark_score = models.DecimalField(
        max_digits=10, decimal_places=2, blank=True, null=True
    )
    blender_score = models.DecimalField(
        max_digits=10, decimal_places=2, blank=True, null=True
    )
...
class GPU(models.Model):
    ...
    base_clock = models.DecimalField(
        max_digits=8, decimal_places=2, blank=True, null=True
    )
    boost_clock = models.DecimalField(
        max_digits=8, decimal_places=2, blank=True, null=True
    ...
    memory_clock = models.DecimalField(
        max_digits=8, decimal_places=2, blank=True, null=True
    )
    ...
    l2_cache_mb = models.DecimalField(
        max_digits=8, decimal_places=2, blank=True, null=True
    )
    tdp = models.IntegerField(blank=True, null=True)
    board_length = models.DecimalField(
        max_digits=6, decimal_places=2, blank=True, null=True
    )
    board_width = models.DecimalField(
        max_digits=6, decimal_places=2, blank=True, null=True
    )
    ...
    display_connectors = models.CharField(
...
class Motherboard(models.Model):
    ...
    ddr_max_speed = models.DecimalField(
        max_digits=8, decimal_places=2, blank=True, null=True
    )
...
class CPUCooler(models.Model):
    ...
    power_throughput = models.DecimalField(
        max_digits=8, decimal_places=2, blank=True, null=True
    )
    slug = models.SlugField(max_length=200, unique=True, blank=True, null=True)
...
class Case(models.Model):
    ...
    external_volume = models.DecimalField(
        max_digits=6, decimal_places=2, blank=True, null=True
    )
